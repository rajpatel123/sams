...
import com.samsapp.adapters.CategoryBookingAdapter;
import com.samsapp.adapters.CityBookingAdapter;
import com.samsapp.adapters.StateBookingAdapter;
import com.samsapp.adapters.SubCatBookingAdapter;
import com.samsapp.adapters.TimeSlotBookingAdapter;
                    ...
                    if (subCategoryResponse != null && subCategoryResponse.getData().getServiceList() != null) {
                        ...
                        choseService.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                            ...
                            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                                ...
                                charge.setText("Service Charge " + price);
...
// &=1
                    ...
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        ...
                        try {
                            ...
                            if (response.code() == 200) {
                                ...
                                Toast.makeText(BookRequestActivity.this, "Server not responding, please try again later", Toast.LENGTH_LONG).show();
                            }
    ...
    public void calculateDiff(int a[][]) {
